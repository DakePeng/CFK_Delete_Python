...
'''
    ...
    it takes roughly 45 seconds to download 1 GB worth of files
    ...
    with open(error_file, "w") as error_log:
        ...
        for j in range(num_times_to_run):
            ...
            with open(output_file, "w") as std_log:
                ...
                subprocess.run(["python", "CFKdownload_subprocess.py"], stdout= std_log, stderr= error_log)
            i += 1
